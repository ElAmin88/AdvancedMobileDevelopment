...
public class DatabaseAdapter   {
    ...
    public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_USERNAME, KEY_SCORE, KEY_DATE};
    ...
    public long insertRow(Player p) {
        // [TO_DO_A8]
        // Update data in the row with new fields.
        // Also change the function's arguments to be what you need!
        // Create row's data:
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_USERNAME, p.getUsername());
        initialValues.put(KEY_SCORE, p.getScore());
        initialValues.put(KEY_DATE, p.getDate());
